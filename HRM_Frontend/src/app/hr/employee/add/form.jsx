            ...
            <Form className="mb-4">
              {currentStep === 1 && (
                <>
                  ...
                  <div>
                    <h1 className="mb-3 text-orange-500 border-b-2 font-bold py-4 border-orange-300">
                      Address
                    </h1>
              ...
              <div className="flex justify-between mt-8">
                {currentStep > 1 && (
                  <Button
                    ...
                    className="btn_gray px-3 py-2 text-sm rounded-xl"
                  >
                    Previous
                  </Button>
                )}
                {currentStep == 1 && (
                  <Button
                    type="button"
                    onClick={() => router.back()} // handleCancel function to be defined
                    className="btn_gray px-3 py-2 text-sm rounded-xl" // Style for cancel button
                  >
                    Cancel
                  </Button>
                )}
